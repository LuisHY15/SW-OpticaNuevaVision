...
if ( isset($_GET['m']) ){
	switch($_GET['m']) {
		...
		/* clientes */
		case "historial":
			$paginaPHP = "php/historial.php";
		break;
		case "historialAgregar":
			$paginaPHP = "php/historialAgregar.php";
		break;
		case "historialModificar":
			$paginaPHP = "php/historialModificar.php";
		break;
		case "pventa":
		...
		break;
		case "pventaModificar":
			$paginaPHP = "php/pventaModificar.php";
		break;
	}
} else {
	...
	<section class="vbox">
		<header class="bg-black dk header navbar navbar-fixed-top-xs">
			<div class="navbar-header aside-md">
				...
				<a href="#" class="navbar-brand" data-toggle="fullscreen">Optica Nueva Vision</a>
						...
						<section class="w-f scrollable">
							<div class="slim-scroll" data-height="auto" data-disable-fade-out="true" data-distance="0" data-size="5px" data-color="#333333">
								...
								<nav class="nav-primary hidden-xs">
									<ul class="nav">
										<li> <a href="admin.php?m=historial"> <i class="fa fa-angle-right"></i> <span>Historial</span> </a> </li>
